...
class MainActivity : SimpleActivity() {
    ...
    companion object {
        ...
        //external fun getHelloWorldString(): Int
        external fun receiver(): Int
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Launches another thread so that the app can actually run
        val cppCallThread = object : Thread() {
            override fun run() {
                val temp = receiver()
                runOnUiThread {
                    Log.d("CPP.MAINACTIVITY", temp.toString())
                }
            }
        }
        cppCallThread.start()
